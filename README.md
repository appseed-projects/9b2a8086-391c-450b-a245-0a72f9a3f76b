...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-18 15:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9b2a8086-391c-450b-a245-0a72f9a3f76b.git
$ cd 9b2a8086-391c-450b-a245-0a72f9a3f76b
```
